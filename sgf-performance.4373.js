(()=>{
  ...
  async function registrarSW(){
    try{
      ...
      const reg=await navigator.serviceWorker.register('./sw-sgf-4373.js',{scope:'./',updateViaCache:'none'});
  ...
  function prefetchEstatico(){
    link('prefetch','sgf-module.4373.js','script');
  ...
  if(/(?:^|\/)index\.html$/.test(location.pathname)||location.pathname.endsWith('/'))link('prefetch','main.html?v=4.3.81','document');
